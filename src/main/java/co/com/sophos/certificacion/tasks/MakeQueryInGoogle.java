...
public class MakeQueryInGoogle implements Task {

    private MakeQueryInGoogle makeQueryInGoogle;

    public MakeQueryInGoogle () {}
    ...
    public static MakeQueryInGoogle makeQueryInGoogle() {
        return Tasks.instrumented(MakeQueryInGoogle.class);
    }
}
